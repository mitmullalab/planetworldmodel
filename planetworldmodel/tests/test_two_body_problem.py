...
def test_random_two_body_problem(target_eccentricity, tol=1e-3, seed=0):
    two_body_problem = random_two_body_problem(target_eccentricity, seed)
    *_, eccentricity = generate_trajectories(two_body_problem)
